...
export class UpdateUserComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getAllSchedule();
    this.getAllCargues();
    console.log("inputUser is ", this.inputUser);
  }

  createFormEditUser(): void {
    this.updateUserForm = this.fb.group({
      id: new FormControl(this.inputUser.id),
      codChargue: new FormControl(
        this.inputUser.codChargue,
        Validators.required
      ),
      codSchedule: new FormControl(
        this.inputUser.codSchedule,
        Validators.required
      ),
